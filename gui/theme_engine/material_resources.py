...
from gui.theme_engine.md_icon_definitions import md_icons
from gui.theme_engine.color_definitions import colors, light_colors
...
ICON_DEFAULT = gui.theme_engine.images_path + "ic_lens_grey_48dp.png"


FONTS = [
    {
        "name": "Roboto",
        "fn_regular": gui.theme_engine.fonts_path + 'Roboto-Regular.ttf',
        "fn_bold": gui.theme_engine.fonts_path + 'Roboto-Medium.ttf',
		"fn_italic": gui.theme_engine.fonts_path + 'Roboto-Italic.ttf',
		"fn_bolditalic": gui.theme_engine.fonts_path + 'Roboto-MediumItalic.ttf'
    },
    {
        "name": "RobotoLight",
        "fn_regular": gui.theme_engine.fonts_path + 'Roboto-Thin.ttf',
		"fn_bold": gui.theme_engine.fonts_path + 'Roboto-Light.ttf',
		"fn_italic": gui.theme_engine.fonts_path + 'Roboto-ThinItalic.ttf',
		"fn_bolditalic": gui.theme_engine.fonts_path + 'Roboto-LightItalic.ttf'
    },
	{
        "name": "Icons",
        "fn_regular": gui.theme_engine.fonts_path + 'Material-Design-Iconic-Font.ttf'
    }
]
