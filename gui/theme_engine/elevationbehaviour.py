...
class ElevationBehaviour(object):
	...
	def __init__(self, **kwargs):
		...
		self.texture_hard = Image('atlas://' + gui.theme_engine.images_path + 'el_shadows.atlas/h_shadow', mipmap=True).texture
		self.texture_soft = Image('atlas://' + gui.theme_engine.images_path + 'el_shadows.atlas/s_shadow', mipmap=True).texture
...
class CircularElevationBehaviour(object):
	...
	def __init__(self, **kwargs):
		...
		self.texture_hard = Image('atlas://' + gui.theme_engine.images_path + 'el_c_shadows.atlas/h_shadow', mipmap=True).texture
		self.texture_soft = Image('atlas://' + gui.theme_engine.images_path + 'el_c:shadows.atlas/s_shadow', mipmap=True).texture
		super(ElevationBehaviour, self).__init__(**kwargs)
