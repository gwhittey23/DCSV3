...
class MaterialLabel(ThemeBehaviour, Label):
	...
	:class:`gui.theme_engine.theme.ThemeBehaviour`, :class:`kivy.uix.Label`
	and :class:`gui.theme_engine.layouts.BackgroundColorCapableWidget`.
	"""
	...
	Look at the	documentation on :class:`~gui.theme_engine.theme.ThemeManager` for more information.
	...
	"""Use :attr:`theme_style` to override the default :class:`~gui.theme_engine.theme.ThemeManager.theme_style`.
